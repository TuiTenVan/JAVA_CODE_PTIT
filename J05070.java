...
class BongDa2{
    ...
    public BongDa2(String ma, String ten, String gia){
        this.ma = ma;
        this.ten = ten;
        this.gia = gia;
    }
...
public class J05070 {
    public static void main(String[] args) {
        ...
        List<BongDa2> list = new ArrayList<BongDa2>();
        while(t-- > 0){
            String ma = sc.nextLine();
            String ten = sc.nextLine();
            String gia = sc.nextLine();
            list.add(new BongDa2(ma, ten, gia));
        }
        ...
        ans.sort((s1,s2) -> {
            ...
            int b = Integer.parseInt(arr2[arr2.length - 1]);
            if(a == b){
